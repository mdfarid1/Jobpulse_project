...
Route::group(['middleware' => ['install']], function () {
    // Route::get('/post','BlogController@post')->name('blog.post');
    //         Route::get('/view/{id}','BlogController@view')->name('view.post');
    Route::get('/circular','BlogController@post')->name('blog.post');
    Route::get('circular/view/{id}','BlogController@view')->name('view.post');
    Route::get('apply/create/{id}', 'ApplyController@apply');
    Route::post('apply/store/{job_id}', 'ApplyController@applystore');
    Route::post('/delete-apply/{id}', 'ApplyController@deleteapply')->name('delete.apply');


    // Route::get('/member','UserController@member')->name('member.show');
    // Route::get('/profile/{id}','UserController@member_profile')->name('member.profile');
    Route::get('/gallery','BlogController@gallery')->name('gallery.show');
    Route::get('/director','GovornorController@governor')->name('governor.show');


    Route::get('/post','CircularController@jobCircularShow')->name('jobCircular');
	Route::get('post/view/{id}','CircularController@jobCircularView')->name('jobCircular.view');

	Route::get('/', 'WebsiteController@index');
	Route::get('sign_up', 'WebsiteController@sign_up');
	Route::get('districts/get_by_division', 'WebsiteController@get_districts')->name('signup.district');
	Route::get('upazilas/get_by_district', 'WebsiteController@get_upazilas')->name('signup.upazila');
    ...
    Route::match(['get', 'post'],'register/candidate_signup','\App\Http\Controllers\Auth\RegisterController@client_signup');
	...
	Route::group(['middleware' => ['auth','verified']], function () {
		...
		Route::get('circular/create', 'ProfileController@postedit');
        Route::post('post/store','ProfileController@post_update');
		Route::get('circular/list', 'ProfileController@postlist');
		Route::get('circular/edit/{id}', 'ProfileController@circularEdit');
		Route::post('circular/update/{id}', 'ProfileController@circularUpdate');
        Route::post('/delete-circular/{id}', 'BlogController@deleteCircular')->name('delete.circular');


		Route::get('apply/list', 'ApplyController@applyList');
        Route::put('/apply/{apply}', 'ApplyController@update')->name('apply.update');



		// Route::get('apply/create', 'ApplyController@apply');
	    ...
	    Route::post('membership/ssl_payment','MembershipController@ssl_payment')->name('member.payment');
		...
		Route::post('membership/success','MembershipController@success');

	    Route::post('membership/fail','MembershipController@fail_ssl');

	    Route::post('membership/cancel','MembershipController@cancel_ssl');
		...
		Route::group(['middleware' => ['admin']], function () {
            ...
            Route::get('switch-to-another-user/{id}','UserController@switchUser')->name('switch.user.to.another');


            Route::get('/carusel','BlogController@carusel')->name('carusel.list');
            Route::get('carusel/edit/{id}','BlogController@editcarusel')->name('carusel.edit');
            Route::post('carusel/update/{id}','BlogController@updatecarusel')->name('carusel.update');
            Route::post('carusel/delete/{id}','BlogController@destroycarusel')->name('carusel.destroy');


			Route::get('/gallery/list','GalleryController@gallery')->name('gallery.list');
			Route::get('gallery/create','GalleryController@galleryCreate')->name('gallery.create');
			Route::post('gallery/store','GalleryController@galleryStore')->name('gallery.store');
			Route::get('gallery/edit/{id}','GalleryController@editgallery')->name('services.edit');
			Route::post('gallery/update/{id}','GalleryController@updategallery')->name('gallery.update');
			Route::post('gallery/delete/{id}','GalleryController@destroygallery')->name('gallery.destroy');



            Route::get('director/list','GovornorController@governing')->name('governing.list');
			Route::get('director/create','GovornorController@governingCreate')->name('governing.create');
			Route::post('director/store','GovornorController@governingStore')->name('governing.store');
			Route::get('director/edit/{id}','GovornorController@editGoverning')->name('governing.edit');
			Route::post('director/update/{id}','GovornorController@updateGoverning')->name('governing.update');
			Route::post('governing/delete/{id}','GovornorController@destroyGoverning')->name('governing.destroy');




            Route::get('blog/list','CircularController@jobCircular')->name('blog.list');
			Route::get('blog/create','CircularController@jobCircularCreate')->name('blog.create');
			Route::post('blog/store','CircularController@jobCircularStore')->name('blog.store');
			Route::get('blogs/edit/{id}','CircularController@editjobCircular')->name('blog.edit');
			Route::post('blog/update/{id}','CircularController@updatejobCircular')->name('blog.update');
			Route::post('blog/delete/{id}','CircularController@destroyjobCircular')->name('blog.destroy');
			...
			Route::get('/service','ServiceController@service')->name('service.list');
			Route::get('services/edit/{id}','ServiceController@editService')->name('services.edit');
			Route::post('services/update/{id}','ServiceController@updateservices')->name('services.update');
			Route::post('services/delete/{id}','ServiceController@destroyservices')->name('services.destroy');



            Route::get('/member','UserController@member')->name('member.show');
            Route::get('/profile/{id}','UserController@member_profile')->name('member.profile');
            Route::post('/delete-user/{id}', 'DashboardController@deleteUser')->name('delete.user');





            Route::get('/circular/show','BlogController@postshow');

            Route::get('/blog/edit/{id}','BlogController@blogedit');

            Route::post('/blog/update/{id}','BlogController@blogupdate');
            Route::post('/delete-post/{id}', 'BlogController@deletePost')->name('delete.post');
		...
		Route::group(['middleware' => ['company']], function () {
            ...
            Route::get('/gallery','BlogController@gallery')->name('gallery.show');
            Route::get('/governor','GovornorController@governor')->name('governor.show');

			//Contact Controller
			Route::match(['get', 'post'],'contacts/import','ContactController@import')->name('contacts.import');
			Route::get('contacts/leave/{id}','ContactController@leave')->name('contact.leave');
			Route::patch('contacts/updateLeave/{id}','ContactController@updateLeave');
			Route::get('contacts/get_table_data','ContactController@get_table_data');
			Route::get('attendance/show-student','ContactController@showList')->name('show.list');
			Route::delete('attendance/delete/{id}','ContactController@destroyAttendance')->name('attend.destroy');
			Route::post('students/send_email/{id}','ContactController@send_email')->name('contacts.send_email');
			Route::resource('students','ContactController');
			Route::get('show_leave','ContactController@showLeaveList')->name('leave_list');

			//Subject Controller
            Route::resource('subjects','SubjectController');
            Route::post('subjects/get_table_data','SubjectController@get_table_data');

			Route::get('/attendance', 'ContactController@student_attendance')->name('attendance');
			Route::get('/pass', 'ContactController@get_pass')->name('pass.page');
			Route::post('/pass', 'ContactController@pass_post');
			Route::post('/list', array('as' => 'list.attendance','uses' => 'ContactController@listAttendance'));



			// Route::get('contacts/create','ContactController@create')->name('contacts.store');
	    	Route::post('/attendance/save', 'ContactController@saveAttendance')->name('attendance.create');
            // Subject Wise Attendance
		    Route::get('/subject-attendance', 'ContactController@student_attendance_subject')->name('attendance.subject');
			Route::match(['get', 'post'],'attendance/subject/{subject_id}','ContactController@subject_wise_attendance')->name('attendance.subject_wise_attendance');



			//Institute Class Controller

			Route::resource('classes','InstituteClassController');
			Route::get('classes/get_table_data','InstituteClassController@get_table_data');
			// Route::get('classes/create','InstituteClassController@create')->name('classes.store');

            //Vehicle Controller

			Route::get('vehicles/type/get_vehicle_type_data','VehicleController@get_vehicle_type_data');
			Route::get('vehicles/type','VehicleController@vehicle_type_view')->name('vehicle.type');
			Route::post('/vehicles/type', array('as' => 'list.vehiclestype','uses' => 'VehicleController@listVehiclesType'));
			Route::post('/vehicles/type/save', 'VehicleController@saveVehicleType')->name('type.create');
		    Route::post('/update', array('as' => 'update.vehicleType','uses' => 'VehicleController@updateVehicleType'));
		    Route::post('/vehicles/type/sts', array('as' => 'sts.type','uses' => 'VehicleController@statusVehicleType'));
			Route::get('/vehicles/{id}', array('as' => 'vehicle_show','uses' => 'VehicleController@show'));

			Route::get('vehicles','VehicleController@showVehicles')->name('show.vehicle');
			Route::post('/vehicles', array('as' => 'list.vehicles','uses' => 'VehicleController@listVehicles'));
			Route::post('/vehicles/save', 'VehicleController@saveVehicle')->name('vehicle.create');
			Route::post('/vehicles/update', array('as' => 'update.vehicle','uses' => 'VehicleController@updateVehicle'));
			Route::post('/sts', array('as' => 'sts.vehicle','uses' => 'VehicleController@statusVehicle'));
			...
			Route::get('holidays-calendar','HolidayController@calendar')->name('holidays.calendar');
            ...
            //blog_category
            // Route::get('/blog_category/{id}','BlogController@category')->name('blog.category');

            // //blog_category_view
            // Route::get('/blog_category_view/{slug}','BlogController@category_view')->name('blog.details');

            // // supper admin blogcategory  backend
            // Route::get('/blogcategory','BlogController@blogcategory');

            // // blogcategory create backend
            // Route::post('/blogcategorycreate','BlogController@blogcategorycreate');

            // // blog create backend
            // Route::post('/blogcreate','BlogController@blogcreate');
            ...
            // // supper admin blogcategoryview  backend
            // Route::get('/blogcategoryview','BlogController@blogcategoryview');

            // // supper admin blog_add  backend
            // Route::get('/blog_base','BlogController@blog_base');

            // // supper admin blog_view added backend
            // Route::get('/show','BlogController@show');

			//Driver Controller
			Route::group(['prefix' => 'drivers'], function ()
		    {
		        Route::get('/', 'DriverController@showDrivers')->name('drivers');
		        Route::post('/list', array('as' => 'list.drivers','uses' => 'DriverController@listDriver'));
		        Route::post('/save', 'DriverController@saveDriver')->name('driver.create');
		        Route::post('/update', array('as' => 'update.driver','uses' => 'DriverController@updateDriver'));
		        Route::post('/sts', array('as' => 'sts.driver','uses' => 'DriverController@statusDriver'));
		        // Route::post('/del', array('as' => 'del.contact','uses' => 'AdminController@delContact'));

		    });
		    Route::get('/drivers/{id}', array('as' => 'driver_show','uses' => 'DriverController@show'));

			//Product Controller
			Route::match(['get', 'post'],'services/import','ServiceController@import')->name('services.import');
			// Route::resource('services','ServiceController');
			// Route::get('/service','ServiceController@service')->name('service.list');
			// Route::get('notices/create','ServiceController@noticeCreate')->name('notices.create');
			// Route::get('services/edit/{id}','ServiceController@editNotice')->name('notices.edit');
			// Route::get('notices/show/{id}','ServiceController@showNotice')->name('notices.show');
			// Route::patch('notices/update/{id}','ServiceController@updateNotice')->name('notices.update');
			// Route::delete('notices/delete/{id}','ServiceController@destroyNotice')->name('notices.destroy');
			...
			Route::post('invoices/sts', array('as' => 'sts.invoice','uses' => 'InvoiceController@statusBooking'));
			Route::get('invoice/calendar','InvoiceController@calendar')->name('invoice.invoice_calendar');
			...
			Route::match(['get', 'post'],'sms/sms_settings/{store?}', 'SmsController@settings')->name('sms.settings');
			...
			//Company SMS Template
			Route::get('company_sms_template/get_template/{id}','CompanySmsTemplateController@get_template');
			Route::resource('company_sms_template','CompanySmsTemplateController');
			Route::match(['get', 'post'],'send_sms/{view?}', 'CompanySmsTemplateController@send_sms')->name('send.sms.absent');


			//SMS Template
			Route::get('sms/list','SmsController@index')->name('sms.index');
			Route::get('sms/create','SmsController@create')->name('sms.create');
			Route::get('sms/edit/{id}','SmsController@edit')->name('sms.edit');
			Route::post('sms/edit/{id}','SmsController@update');
			...
			Route::match(['get', 'post'],'reports/daily_attendance/{view?}', 'ReportController@daily_attendance')->name('reports.daily_attendance');
			Route::match(['get', 'post'],'reports/month_wise_attendance/{view?}', 'ReportController@month_wise_attendance')->name('reports.month_wise_attendance');
			...
			Route::match(['get', 'post'],'reports/in_out_log/{view?}', 'ReportController@in_out_log')->name('reports.in_out_log');
            // Route::post('monthly-top-report', [ReportController::class, 'monthlyTopSheetPrint'])->name('monthly.top-sheet-print');
		});
		...
		Route::group(['middleware' => ['client']], function () {
		    ...
		    //Projects
		    Route::get('appied/job','ClientController@projects');
	...
	//Get Driver Info
	Route::get('drivers/get_driver_info/{id}','DriverController@get_driver_info');

	//Get Vehicle Info
	Route::get('vehicles/get_vehicle_info/{id}','VehicleController@get_vehicle_info');
	...
	Route::get('c/i/{id}','ClientController@view_invoice');
