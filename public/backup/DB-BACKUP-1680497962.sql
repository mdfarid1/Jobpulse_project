...
CREATE TABLE `activity_logs` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `related_to` varchar(20) DEFAULT NULL,
...
CREATE TABLE `blogs` (
  ...
  `social_link_fb` varchar(191) DEFAULT NULL,
  `social_link_gg` varchar(191) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `companies` (
  ...
  `staff_limit` varchar(20) DEFAULT NULL,
  `contacts_limit` varchar(20) DEFAULT NULL,
  `drivers_limit` varchar(191) DEFAULT NULL,
  `vehicles_limit` varchar(191) NOT NULL DEFAULT 'No',
  `invoice_limit` varchar(20) DEFAULT NULL,
  `quotation_limit` varchar(20) DEFAULT NULL,
  `recurring_transaction` varchar(3) DEFAULT NULL,
  `live_chat` varchar(3) DEFAULT NULL,
  `file_manager` varchar(3) DEFAULT NULL,
  `inventory_module` varchar(3) DEFAULT NULL,
  `pos_module` varchar(3) DEFAULT NULL,
  `hrm_module` varchar(3) DEFAULT NULL,
  `payroll_module` varchar(3) DEFAULT NULL,
  `project_management_module` varchar(3) DEFAULT NULL,
  `online_payment` varchar(3) DEFAULT NULL,
  `sms_panel` varchar(255) DEFAULT 'No',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO companies VALUES('1','ABC Public School & College','1','3','monthly','member','2023-04-30','','30','5','3','0','300','300','Yes','Yes','Yes','Yes','','','','Yes','Yes','Yes','2022-11-01 10:19:42','2023-03-30 11:22:33');
INSERT INTO companies VALUES('19','Mizbah Transport','1','1','yearly','member','2024-03-14','','No','No','No','No','No','No','No','No','No','No','','','','No','No','No','2023-01-05 12:44:42','2023-03-14 10:43:41');
INSERT INTO companies VALUES('20','EFG School','1','3','monthly','member','2023-05-02','','30','5','','No','300','300','Yes','Yes','Yes','Yes','','','','Yes','Yes','Yes','2023-04-02 12:29:01','2023-04-02 12:45:04');
...
INSERT INTO company_settings VALUES('22','timezone','Asia/Dhaka','1','2022-11-01 11:11:58','2023-03-01 10:17:45');
INSERT INTO company_settings VALUES('23','date_format','d M, Y','1','2022-11-01 11:11:58','2023-03-01 10:17:45');
INSERT INTO company_settings VALUES('24','time_format','12','1','2022-11-01 11:11:58','2023-03-01 10:17:45');
INSERT INTO company_settings VALUES('25','quotation_starting','1','1','2022-12-14 14:29:01','2023-01-24 15:38:00');
INSERT INTO company_settings VALUES('26','company_name','ABC Public School & College','1','2022-12-18 11:43:19','2023-02-22 16:25:29');
INSERT INTO company_settings VALUES('27','phone','01615352866','1','2022-12-18 11:43:19','2023-02-22 16:25:29');
INSERT INTO company_settings VALUES('28','vat_id','','1','2022-12-18 11:43:19','2023-02-22 16:25:29');
INSERT INTO company_settings VALUES('29','reg_no','','1','2022-12-18 11:43:19','2023-02-22 16:25:29');
INSERT INTO company_settings VALUES('30','email','abcmail@mail.com','1','2022-12-18 11:43:19','2023-02-22 16:25:29');
INSERT INTO company_settings VALUES('31','address','House 3, Road No-9/B, Uttara 5 no. Sector Dhaka','1','2022-12-18 11:43:19','2023-02-22 16:25:29');
...
INSERT INTO company_settings VALUES('36','sms_api_link','http://66.45.237.70/api.php?username=[U]&password=[P]&number=[T]&senderid=[F]&message=[M]','1','2022-12-22 11:16:52','2022-12-22 11:37:11');
...
INSERT INTO company_settings VALUES('54','max_entry_time','20','1','2023-02-15 14:27:35','2023-03-01 10:17:45');
INSERT INTO company_settings VALUES('55','duration_time','30','1','2023-02-15 14:27:35','2023-03-01 10:17:45');
...
INSERT INTO company_sms_templates VALUES('2','Enter','Student Exit','<pre class=\"border border-info p-2\">{student_name} ({id_no}) is entered at</pre>
<pre id=\"enter-paremeter\" class=\"border border-info p-2\">{enter_time}</pre>','enter','1','1','2023-03-28 14:36:48','2023-04-01 10:34:39');
...
CREATE TABLE `drivers` (
  ...
  `license_picture` varchar(191) DEFAULT NULL,
  ...
  `company_id` int(11) NOT NULL,
  `temporary` tinyint(4) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `file_manager` (
  ...
  `is_dir` varchar(3) NOT NULL DEFAULT 'no',
...
CREATE TABLE `fuels` (
  ...
  `fuel_from` varchar(191) DEFAULT NULL,
...
CREATE TABLE `notices` (
  ...
  `title` varchar(191) NOT NULL,
  `body` text NOT NULL,
  `status` tinyint(4) DEFAULT 1 COMMENT '0 = Deactive | 1 = Active',
  `company_id` int(11) DEFAULT NULL,
...
CREATE TABLE `packages` (
  ...
  `staff_limit` varchar(191) NOT NULL,
  `contacts_limit` varchar(191) NOT NULL,
  `vehicles_limit` varchar(191) NOT NULL DEFAULT 'No',
  `invoice_limit` varchar(191) NOT NULL,
  `quotation_limit` varchar(191) NOT NULL,
  `recurring_transaction` varchar(191) NOT NULL,
  `live_chat` varchar(191) NOT NULL,
  `file_manager` varchar(191) NOT NULL,
  `inventory_module` varchar(191) DEFAULT NULL,
  `pos_module` varchar(191) DEFAULT NULL,
  `hrm_module` varchar(191) DEFAULT NULL,
  `payroll_module` varchar(191) DEFAULT NULL,
  `project_management_module` varchar(191) DEFAULT NULL,
  `online_payment` varchar(191) NOT NULL,
  `sms_panel` varchar(255) DEFAULT 'No',
...
INSERT INTO packages VALUES('1','Basic','500.00','5000.00','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','','','','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','1','','','2023-03-15 12:21:06');
INSERT INTO packages VALUES('2','Standard','1000.00','10000.00','a:2:{s:7:\"monthly\";s:2:\"10\";s:6:\"yearly\";s:2:\"20\";}','a:2:{s:7:\"monthly\";s:1:\"2\";s:6:\"yearly\";s:1:\"2\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:3:\"300\";s:6:\"yearly\";s:3:\"500\";}','a:2:{s:7:\"monthly\";s:3:\"300\";s:6:\"yearly\";s:3:\"500\";}','a:2:{s:7:\"monthly\";s:3:\"Yes\";s:6:\"yearly\";s:3:\"Yes\";}','a:2:{s:7:\"monthly\";s:3:\"Yes\";s:6:\"yearly\";s:3:\"Yes\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:3:\"Yes\";s:6:\"yearly\";s:3:\"Yes\";}','','','','a:2:{s:7:\"monthly\";s:3:\"Yes\";s:6:\"yearly\";s:3:\"Yes\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','a:2:{s:7:\"monthly\";s:2:\"No\";s:6:\"yearly\";s:2:\"No\";}','1','','','2022-12-21 16:35:33');
INSERT INTO packages VALUES('3','Business Plus','2000.00','20000.00','a:2:{s:7:\"monthly\";s:2:\"30\";s:6:\"yearly\";s:9:\"Unlimited\";}','a:2:{s:7:\"monthly\";s:1:\"5\";s:6:\"yearly\";s:2:\"10\";}','a:2:{s:7:\"monthly\";s:2:\"10\";s:6:\"yearly\";s:2:\"20\";}','a:2:{s:7:\"monthly\";s:3:\"300\";s:6:\"yearly\";s:9:\"Unlimited\";}','a:2:{s:7:\"monthly\";s:3:\"300\";s:6:\"yearly\";s:9:\"Unlimited\";}','a:2:{s:7:\"monthly\";s:3:\"Yes\";s:6:\"yearly\";s:3:\"Yes\";}','a:2:{s:7:\"monthly\";s:3:\"Yes\";s:6:\"yearly\";s:3:\"Yes\";}','a:2:{s:7:\"monthly\";s:3:\"Yes\";s:6:\"yearly\";s:3:\"Yes\";}','a:2:{s:7:\"monthly\";s:3:\"Yes\";s:6:\"yearly\";s:3:\"Yes\";}','','','','a:2:{s:7:\"monthly\";s:3:\"Yes\";s:6:\"yearly\";s:3:\"Yes\";}','a:2:{s:7:\"monthly\";s:3:\"Yes\";s:6:\"yearly\";s:3:\"Yes\";}','a:2:{s:7:\"monthly\";s:3:\"Yes\";s:6:\"yearly\";s:3:\"Yes\";}','0','','','2022-12-13 13:12:57');
...
INSERT INTO payment_histories VALUES('83','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 11:09:42','2023-03-14 11:09:42');
INSERT INTO payment_histories VALUES('82','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 11:04:01','2023-03-14 11:04:01');
...
INSERT INTO payment_histories VALUES('84','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 11:12:46','2023-03-14 11:12:46');
INSERT INTO payment_histories VALUES('85','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 11:17:32','2023-03-14 11:17:32');
INSERT INTO payment_histories VALUES('86','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 11:23:36','2023-03-14 11:23:36');
INSERT INTO payment_histories VALUES('87','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 11:33:16','2023-03-14 11:33:16');
INSERT INTO payment_histories VALUES('88','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 11:33:55','2023-03-14 11:33:55');
INSERT INTO payment_histories VALUES('89','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 11:36:19','2023-03-14 11:36:19');
INSERT INTO payment_histories VALUES('90','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 12:33:22','2023-03-14 12:33:22');
INSERT INTO payment_histories VALUES('91','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 12:35:15','2023-03-14 12:35:15');
INSERT INTO payment_histories VALUES('92','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 12:35:48','2023-03-14 12:35:48');
INSERT INTO payment_histories VALUES('93','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 12:36:21','2023-03-14 12:36:21');
INSERT INTO payment_histories VALUES('94','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 12:45:03','2023-03-14 12:45:03');
INSERT INTO payment_histories VALUES('95','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 13:22:41','2023-03-14 13:22:41');
INSERT INTO payment_histories VALUES('96','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 13:23:27','2023-03-14 13:23:27');
INSERT INTO payment_histories VALUES('97','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 13:26:41','2023-03-14 13:26:41');
INSERT INTO payment_histories VALUES('98','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 13:43:29','2023-03-14 13:43:29');
INSERT INTO payment_histories VALUES('99','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 13:59:45','2023-03-14 13:59:45');
INSERT INTO payment_histories VALUES('100','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 14:02:07','2023-03-14 14:02:07');
INSERT INTO payment_histories VALUES('101','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 14:30:00','2023-03-14 14:30:00');
INSERT INTO payment_histories VALUES('102','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 14:44:41','2023-03-14 14:44:41');
INSERT INTO payment_histories VALUES('103','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 14:45:44','2023-03-14 14:45:44');
INSERT INTO payment_histories VALUES('104','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 14:45:56','2023-03-14 14:45:56');
INSERT INTO payment_histories VALUES('105','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 14:48:23','2023-03-14 14:48:23');
INSERT INTO payment_histories VALUES('106','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 14:57:02','2023-03-14 14:57:02');
INSERT INTO payment_histories VALUES('107','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 14:58:31','2023-03-14 14:58:31');
INSERT INTO payment_histories VALUES('108','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 14:59:39','2023-03-14 14:59:39');
INSERT INTO payment_histories VALUES('109','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 15:06:06','2023-03-14 15:06:06');
INSERT INTO payment_histories VALUES('110','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 15:29:45','2023-03-14 15:29:45');
INSERT INTO payment_histories VALUES('111','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 16:21:51','2023-03-14 16:21:51');
INSERT INTO payment_histories VALUES('112','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 16:26:31','2023-03-14 16:26:31');
INSERT INTO payment_histories VALUES('113','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 16:55:17','2023-03-14 16:55:17');
INSERT INTO payment_histories VALUES('114','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 17:11:38','2023-03-14 17:11:38');
INSERT INTO payment_histories VALUES('115','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 17:11:46','2023-03-14 17:11:46');
INSERT INTO payment_histories VALUES('116','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 17:22:30','2023-03-14 17:22:30');
INSERT INTO payment_histories VALUES('117','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 17:32:34','2023-03-14 17:32:34');
INSERT INTO payment_histories VALUES('118','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 17:40:58','2023-03-14 17:40:58');
INSERT INTO payment_histories VALUES('119','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 17:42:31','2023-03-14 17:42:31');
INSERT INTO payment_histories VALUES('120','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 17:42:45','2023-03-14 17:42:45');
INSERT INTO payment_histories VALUES('121','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 17:57:06','2023-03-14 17:57:06');
INSERT INTO payment_histories VALUES('122','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 17:57:53','2023-03-14 17:57:53');
INSERT INTO payment_histories VALUES('123','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 18:04:45','2023-03-14 18:04:45');
INSERT INTO payment_histories VALUES('124','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-14 18:38:11','2023-03-14 18:38:11');
...
INSERT INTO payment_histories VALUES('127','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-21 15:45:38','2023-03-21 15:45:38');
INSERT INTO payment_histories VALUES('128','1','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-03-30 11:19:04','2023-03-30 11:19:04');
...
INSERT INTO payment_histories VALUES('130','20','Buy Standard Package','','BDT','1000.00','2','monthly','pending','2023-04-02 12:43:09','2023-04-02 12:43:09');
INSERT INTO payment_histories VALUES('131','20','Buy Business Plus Package','','BDT','2000.00','3','monthly','pending','2023-04-02 12:43:17','2023-04-02 12:43:17');
...
CREATE TABLE `products` (
  ...
  `tax_method` varchar(10) NOT NULL,
  `tax_id` bigint(20) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO settings VALUES('7','hero_title','a:2:{s:6:\"Bangla\";s:41:\"Start Your Business With Transport keeper\";s:7:\"English\";s:41:\"Start Your Business With Transport keeper\";}','','2022-11-01 10:27:28');
INSERT INTO settings VALUES('8','hero_sub_title','a:2:{s:6:\"Bangla\";s:170:\"A simple, easy to customize, and powerful business platform for managing and tracking Projects, Tasks, Invoices, Quotations, Leads, Customers, Transactions and many more!\";s:7:\"English\";s:170:\"A simple, easy to customize, and powerful business platform for managing and tracking Projects, Tasks, Invoices, Quotations, Leads, Customers, Transactions and many more!\";}','','2022-11-01 10:27:28');
...
INSERT INTO settings VALUES('43','website_copyright','a:2:{s:6:\"Bangla\";s:25:\"Software Bazar Bangladesh\";s:7:\"English\";s:25:\"Software Bazar Bangladesh\";}','2022-11-01 10:27:25','2022-11-01 10:27:28');
INSERT INTO settings VALUES('44','website_title','Attendance Keeper','2022-11-01 10:27:46','2022-11-01 10:27:46');
INSERT INTO settings VALUES('45','promo_video_url','https://www.youtube.com/watch?v=9y927xiDtJo','2022-11-01 10:29:47','2022-11-01 10:30:30');
INSERT INTO settings VALUES('46','contact_email','akandmahfuz@gmail.com','2022-11-01 10:29:47','2022-11-01 10:30:30');
...
INSERT INTO upazilas VALUES('79','8','Karnaphuli','কর্ণফুলী','karnafuli.chittagong.gov.bd','','');
...
CREATE TABLE `users` (
  ...
  `upazila_id` mediumint(9) NOT NULL,
  `salary` decimal(10,2) DEFAULT NULL,
  `house_rent` decimal(10,2) DEFAULT NULL,
  `mobile_rent` decimal(10,2) DEFAULT NULL,
  `other_bill` decimal(10,2) DEFAULT NULL,
...
INSERT INTO users VALUES('4','Mizbah','','mizbah@gmail.com','2022-12-06 10:46:06','$2y$10$gQooBH.WDVu7d6DJhkyQlOyDutFeKjK1PxBED1nIKydjgZSdcjGN6','client','','default.png','1','','','','','','','','','','','','0','0','0','','','','','','2022-12-06 10:46:06','2022-12-06 10:46:06');
INSERT INTO users VALUES('25','Mizbah','01521484948','mizbahmed161@gmail.com','2023-01-05 12:44:42','$2y$10$xrze9/GDPBnru6fsrum.T.QfvClzC4vZl3UUT00rJZ4wD9kaNiN/i','user','','default.png','1','','','','','','','19','','','','','1','8','79','','','','','','2023-01-05 12:44:43','2023-01-05 12:44:43');
INSERT INTO users VALUES('8','Kamal','','','','','staff','4','default.png','1','','','','','','','1','','','','','0','0','0','','','','','','2022-12-14 13:10:05','2022-12-14 13:10:05');
INSERT INTO users VALUES('26','miz@gmail.com','','miz@gmail.com','2023-01-07 11:20:29','$2y$10$.od8rtaCeOohxNtKY3oJquyNTSoOSR0Y1gwEoibjqFhobTsWwkmiW','client','','default.png','1','','','','','','','','','','','','0','0','0','','','','','','2023-01-07 11:20:30','2023-01-07 11:20:30');
...
INSERT INTO users VALUES('30','Mizbah','01521484948','mizbahmed@gmail.com','2023-04-02 12:29:01','$2y$10$xP64az4D3v6fDOS1LiRf2eME2u3TTCVXZkCzCVTLStm.4/yEeQSSa','user','','default.png','1','','','','','','','20','','','','','0','0','0','','','','','','2023-04-02 12:29:01','2023-04-02 12:29:01');
...
CREATE TABLE `vehicles` (
  ...
  `in_service` tinyint(4) DEFAULT 1,
  `type_id` int(11) NOT NULL,
  `driver_id` int(11) NOT NULL,
  `vehicle_img` varchar(191) DEFAULT NULL,
  `brand` varchar(191) DEFAULT NULL,
  `chassis_no` varchar(191) DEFAULT NULL,
  `eng_no` varchar(191) DEFAULT NULL,
  `capacity` decimal(10,2) DEFAULT NULL,
  `mileage` decimal(10,2) DEFAULT NULL,
  `state` varchar(191) DEFAULT NULL COMMENT 'condition used|new',
  `ins_no` varchar(191) DEFAULT NULL,
  `company_id` int(11) NOT NULL,
