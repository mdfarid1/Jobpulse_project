...
(function($) {
	...
	$(document).on('change', '#vehicle_id', function() {
		...
		$.ajax({
			 method: "GET",
			url: _url + '/vehicles/get_vehicle_info/' + vehicle_id,
			beforeSend: function(){
				$("#preloader").css("display","block");
			},success: function(data){
				$("#preloader").css("display","none");
	...
	$(document).on('change', '#driver_id', function() {
		...
		$.ajax({
			 method: "GET",
			url: _url + '/drivers/get_driver_info/' + driver_id,
			beforeSend: function(){
				$("#preloader").css("display","block");
			},success: function(data){
				$("#preloader").css("display","none");
...
function update_summary(){
    ...
    $("#order-table > tbody > tr").each(function(index, obj) {
        ...
        product_total = product_total + parseFloat($(this).find(".input-sub-total").val()) + total_tax;
    });
