					 ...
					 <div class="card">
						<div class="card-body">
						   ...
						   <form method="post" class="appsvan-submit params-panel" autocomplete="off" action="{{ url('administration/general_settings/update') }}" enctype="multipart/form-data">
								...
								<h5 class="header-title">{{ _lang('SSLCOMMERZ') }}</h5>
								<div class="params-panel border border-dark p-3">
									<div class="row">
										<div class="col-md-4">
										  <div class="form-group">
											<label class="control-label">{{ _lang('SSLCOMMERZ Active') }}</label>
											<select class="form-control" name="ssl_active" required>
											   <option value="Yes" {{ get_option('ssl_active') == 'Yes' ? 'selected' : '' }}>{{ _lang('Yes') }}</option>
											   <option value="No" {{ get_option('ssl_active') == 'No' ? 'selected' : '' }}>{{ _lang('No') }}</option>
											</select>
										  </div>
										</div>
										...
										<div class="col-md-4">
										  <div class="form-group">
											<label class="control-label">{{ _lang('SSLCOMMERZ Email') }}</label>
											<input type="text" class="form-control" name="ssl_email" value="{{ get_option('ssl_email') }}">
										  </div>
										</div>

										<div class="col-md-4">
										  <div class="form-group">
											<label class="control-label">{{ _lang('SSLCOMMERZ Currency') }}</label>
											<select class="form-control select2 auto-select" data-selected="{{ get_option('ssl_currency','BDT') }}" name="ssl_currency" id="ssl_currency" required>
												<option value="BDT">{{ _lang('BDT') }}</option>
											</select>
										  </div>
										</div>
									</div>
								...
								<h5 class="header-title">{{ _lang('BKash Payment') }}</h5>
								<div class="params-panel border border-dark p-3">
									<div class="row">
										<div class="col-md-4">
										  <div class="form-group">
											<label class="control-label">{{ _lang('Bkash Active') }}</label>
											<select class="form-control" name="bkash_active" required>
											   <option value="Yes" {{ get_option('bkash_active') == 'Yes' ? 'selected' : '' }}>{{ _lang('Yes') }}</option>
											   <option value="No" {{ get_option('bkash_active') == 'No' ? 'selected' : '' }}>{{ _lang('No') }}</option>
											</select>
										  </div>
										</div>
										...
										{{-- <div class="col-md-4">
										  <div class="form-group">
											<label class="control-label">{{ _lang('BK Email') }}</label>
										...
										<div class="col-md-4">
                                            <div class="form-group">
                                              <label class="control-label">{{ _lang('Bkash Currency') }}</label>
                                              <select class="form-control select2 auto-select" data-selected="{{ get_option('bkash_currency','BDT') }}" name="bkash_currency" id="bkash_currency" required>
                                                  <option value="BDT">{{ _lang('BDT') }}</option>
                                              </select>
                                            </div>
                                          </div>
