...
<div class="row">
    <div class="col-sm-3">
	    <ul class="nav flex-column nav-tabs settings-tab" role="tablist">
		  ...
		  <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#faq_page">{{ _lang('FAQ Page') }}</a></li>
	...
	<div class="col-sm-9">
		<div class="tab-content">
							...
							<div class="tab-content">
								...
								<div class="tab-pane container {{ $loop->first ? 'active' : '' }}" id="home-language-{{ $loop->index + 1 }}">
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group">
											  <label class="control-label">{{ _lang('Short Description Top') }}</label>
											  <textarea class="form-control summernote" rows="2" name="short_description[{{$language}}]">{{ get_array_option('short_description',$language) }}</textarea>
											</div>
										</div>

                                        <div class="col-md-12">
											<div class="form-group">
											  <label class="control-label">{{ _lang('Short Description Bottom') }}</label>
											  <textarea class="form-control summernote" rows="2" name="short_description_bottom[{{$language}}]">{{ get_array_option('short_description_bottom',$language) }}</textarea>
											</div>
										</div>
            ...
            <div id="faq_page" class="tab-pane fade">
				<div class="card">
				    <div class="card-body">
					    <h4 class="mb-4 header-title panel-title">{{ _lang('FAQ Page') }}</h4>
							...
							<div class="tab-content">
								...
								<div class="tab-pane container {{ $loop->first ? 'active' : '' }}" id="about-language-{{ $loop->index + 1 }}">
									<div class="row">
										...
										<div class="col-md-12">
										  <div class="form-group">
											<label class="control-label">{{ _lang('FAQ Content') }}</label>
											<textarea class="form-control summernote" rows="3" name="faq_content[{{$language}}]">{{ get_array_option('faq_content',$language) }}</textarea>
										  </div>
										</div>
									...
									<div class="row">
										...
										<div class="col-md-12">
										  <div class="form-group">
											...
											<textarea class="form-control summernote" rows="10" name="terms_condition_content[{{$language}}]">{{ get_array_option('terms_condition_content',$language) }}</textarea>
										  </div>
										</div>
