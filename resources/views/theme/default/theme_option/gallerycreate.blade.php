...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-body">
                <h4 class="mb-4 panel-title">{{ _lang('Gallery Add') }}</h4>
				<form  action="{{ url('gallery/store') }}" method="POST" enctype="multipart/form-data">
					@csrf
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <input type="file" class="form-control dropify" name="gallery_img" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG" data-default-file="">
