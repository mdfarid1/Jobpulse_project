        ...
        <div class="col-md-5">
            <div class="card card-signin my-5">
				<div class="login-form-head">
                    <h4>{{ _lang('Candidate Sign Up') }}</h4>
                </div>
                <div class="card-body">
                    <form method="POST" class="form-signup" autocomplete="off" action="{{ url('register/candidate_signup') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <p>Please <a href="{{ url('login') }}">login</a> or <a href="{{ url('register/client_signup') }}">register</a> to apply for this job.</p>
                             </div>
                         </div>
