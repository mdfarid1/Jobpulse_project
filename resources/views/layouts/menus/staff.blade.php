...
<li>
	<a href="javascript: void(0);"><i class="ti-id-badge"></i><span>{{ _lang('Students') }}</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
	<ul class="nav-second-level" aria-expanded="false">
		@if (in_array('students.index',$permissions))
			<li class="nav-item"><a class="nav-link" href="{{ url('students') }}">{{ _lang('Students List') }}</a></li>
		@endif

		@if (in_array('students.create',$permissions))
			<li class="nav-item"><a class="nav-link" href="{{ url('students/create') }}">{{ _lang('Add New') }}</a></li>
		@endif
...
@endif
<li>
	<a href="{{ route('subjects.index') }}"><i class="ti-book"></i><span>{{ _lang('Subjects') }}</span></a>
</li>

<li>
	<a href="{{ route('show.list') }}"><i class="fas fa-table"></i><span>{{ _lang('Present List') }}</span></a>
</li>
