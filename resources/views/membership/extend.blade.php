            ...
            <div class="card card-signin my-5">
                ...
                <div class="card-body" id="extend_membership">
                    <form method="POST" class="form-signup" action="{{ url('membership/pay') }}">
						...
						<div class="col-md-12">
							<div class="form-group">
							  ...
							  <select class="form-control" name="gateway" id="gateway" required>
								  @if (get_option('ssl_active') == 'Yes')
									  <option value="sslcommerz">{{ _lang('Card/Mobile Banking/Internet Banking') }}</option>
								  @endif
                                  @if (get_option('bkash_active') == 'Yes')
									  <option value="bkash">{{ _lang('Bkash Payment') }}</option>
								  @endif
						...
						<div class="form-group">
                            <div><p style="color: red">For Other Payment Option. Contact: 01305486661, 01323150783 </p></div>
						  <div class="col-md-12">
