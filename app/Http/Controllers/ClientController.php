...
class ClientController extends Controller
{
	...
	public function view_invoice($invoice_number){
		$invoice = Invoice::leftjoin('drivers as d','d.id','=','invoices.driver_id')->leftjoin('vehicles as v','v.id','=','invoices.vehicle_id')->select('invoices.*','d.name','v.model')->where('invoice_number',$invoice_number)->first();
	...
	public function view_quotation($id){
		...
		return view("backend.client_panel.quotation-template.$template",compact('quotation','quotation_taxes','company'));
	}
    ...
    //   $data['blogs']= Blog::with('category_circulars', 'applies')->get();
    //     // dd($data);
